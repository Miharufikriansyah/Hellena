...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() .'assets/css/signin.css' ; ?>" type="text/css" media="all">
    <!-- Webtitle -->
    <title>Sign In</title>
    <!-- Jquery -->
...
<body style="background-image:url(<?php echo base_url() . 'assets/Images/BackGround.png'; ?>">
    ...
    <main>
        <div class="signin">
            ...
            <form action="<?= base_url()  ?>HomePatLogin" method="post">
                  <label>Email</label>
              ...
              <a href="<?php echo site_url().'Hellena/registPat'?>" class="regist">Don't Have An Account? <span>Register</span></a>
        </div>
    </main>
